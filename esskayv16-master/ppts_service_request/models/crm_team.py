...
class CrmTeam(models.Model):
    ...
    is_service_request = fields.Boolean('Service Team', copy=False,
                                        help='If this field is enabled then this team will be available to select in service request.')
    ...
    def check_customer_type(self):
        ...
        if self.customer_type:
            customers = self.env['res.partner'].search(
                [('customer_type_partner', '=', self.customer_type), ('customer_account_id', '=', False)])
