...
class ParentTicketConfiguration(models.Model):
    ...
    in_oo_warranty_approved = fields.Boolean(string="Out Of OEM Warranty && Approved")
    in_repair_warranty_approved = fields.Boolean(string="In Repair Warranty && Approved")
    oo_repair_warranty_approved = fields.Boolean(string="Out Of Repair Warranty && Approved")
