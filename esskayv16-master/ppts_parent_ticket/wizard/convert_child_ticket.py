...
class ConvertChildTicket(models.Model):
    ...
    @api.onchange('request_type_id')
    def onchange_request_type_domains(self):
    ...
    def action_child_ticket_create(self):
            ...
            for order in service_request:
                ...
                for line in order.customer_asset_ids:
                    child_tick = {
                        ...
                        'dealer_distributor_id': order.dealer_distributor_id.id,
                    ...
                    child_ticket._onchange_request_type_id()
            ...
            for order in parent_ticket:
                ...
                if self.child_ticket_configuration_id:
                    child_tick = {
                        ...
                        'product_code_no': order.product_code_no,
                        'parent_ticket_id_alias_date': order.parent_ticket_id_alias_date,
                        'team_id': order.team_id.id,
                        'dealer_distributor_id': order.dealer_distributor_id.id,
                        'description': order.description,
                        'survey_id': order.survey_id.id,
                        'child_ticket_attachments': order.attachment_ids,
                    ...
                    notification = child_ticket.notifycation()
                    return notification
        ...
        # message = _("Ticket has been created successfully!")
        # return {
