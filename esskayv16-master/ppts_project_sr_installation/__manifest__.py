{
    ...
    'category': 'masters',
    'depends': ['base', 'project', 'ppts_service_request', 'ppts_parent_ticket', 'hr_expense', 'spare_request',
                'ppts_warranty_replacement'],
    'data': [
