...
class ServiceRequest(models.Model):
    ...
    service_request_date = fields.Datetime(string="System Generate Date", required=True)
    ...
    product_part_number = fields.Char(string='Product Part Number', copy=True, help="CAT No")
    product_part_code = fields.Char(string="Product Part Code", copy=True)
    ...
    def _onchange_partner(self):
        ...
        if self.partner_id:
            ...
            self.customer_id = self.partner_id.id or 0
