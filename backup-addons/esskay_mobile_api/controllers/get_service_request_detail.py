...
class APIController(http.Controller):
    ...
    def _api_get_service_request_types(self, **post):
        ...
        domain = [('request_type_id.ticket_type','=',ticket_type),('company_id','=',company_id)]
        if search_value:
        ...
        if ticket_type == 'sr_loaner':
            ...
            for rec in service_request_ids:
                ...
                user_id = {'key': 'user_id', 'type': rec._fields['user_id'].type,'title': rec._fields['user_id'].string,
                                    'value': rec.user_id.name if rec.user_id else ''}
                service_request_list.append([id,name,service_request_id_alias,service_request_date,approver_id,parent_ticket_id,child_ticket_id,
            ...
            for rec in service_request_ids:
                ...
                survey_id = {'key': 'survey_id', 'type': rec._fields['survey_id'].type,'title': rec._fields['survey_id'].string,
                                    'value': rec.survey_id.title if rec.survey_id else ''}
                service_request_list.append([id,name,service_request_id_alias,service_request_date,approver_id,call_source_id,parent_ticket_id,
            ...
            for rec in service_request_ids:
                ...
                user_id = {'key': 'user_id', 'type': rec._fields['user_id'].type,'title': rec._fields['user_id'].string,
                                    'value': rec.user_id.name if rec.user_id else ''}
                service_request_list.append([id,name,service_request_id_alias,service_request_date,approver_id,
            ...
            for rec in service_request_ids:
                ...
                service_request_list.append([id,name,service_request_id_alias,service_request_date,approver_id,parent_ticket_id,
            ...
            for rec in service_request_ids:
                ...
                service_request_list.append([id,name,service_request_id_alias,service_request_date,service_request_status_id,
        ...
        if service_request_list:
            return valid_response1(service_request_list, count, message, 200)
        else:
            return valid_response1(service_request_list,count, 'there is no service request record', 200)
