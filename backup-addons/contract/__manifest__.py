...
{
    "name": "PPTS : Recurring - Contracts Management",
    "version": "16.0.1.0.0",
    "category": "Contract Management",
    "license": "AGPL-3",
    "author": "Tecnativa, ACSONE SA/NV, Odoo Community Association (OCA)",
    "website": "https://github.com/OCA/contract",
    "depends": ["base", "account", "product", "portal","ppts_custom_masters"],
    ...
    "data": [
        ...
        "wizards/contract_ticket_approval_views.xml",
        ...
        "views/view_calendar_event_tree.xml"
    ],
    "assets": {
        "web.assets_backend": [
