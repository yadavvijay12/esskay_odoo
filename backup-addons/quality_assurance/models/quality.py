...
class QualityTest(models.Model):
    ...
    test_type = fields.Selection(related='quality_measure.type',
                                 ...
                                 readonly=True)
    quantity_min = fields.Float(related='quality_measure.quantity_min',
                                string='Min-Value', store=True, readonly=True)
    quantity_max = fields.Float(related='quality_measure.quantity_max',
